...
public class healthdata_simhyal extends AppCompatActivity {
    Button return_b;
    Button next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.healthdata_simhyal);
        ...
        return_b.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(getApplication(), healthdata_copd.class);
    ...
    public void calculatePercentage() {
        ...
        if(total>0){
            ...
            editor.putInt("simhyal_percentage",percentage);
            editor.apply();

            //다음 페이지 이동
            Intent intent=new Intent(healthdata_simhyal.this, healthdata_symptom_result.class);
            startActivity(intent);
        }
