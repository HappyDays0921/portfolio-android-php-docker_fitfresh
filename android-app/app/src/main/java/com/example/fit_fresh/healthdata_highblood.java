...
public class healthdata_highblood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.healthdata_highblood);
        ...
        return_b.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(getApplication(), healthdata_goji.class);
    ...
    public void calculatePercentage() {
        ...
        if(total>0){
            ...
            editor.putInt("highblood_percentage",percentage);
            editor.apply();

            //다음 페이지 이동
            Intent intent=new Intent(healthdata_highblood.this, healthdata_copd.class);
            startActivity(intent);
        }
