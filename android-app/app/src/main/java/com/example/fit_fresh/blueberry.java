...
public class blueberry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = findViewById(R.id.lv_blueberry);
        List<String> data= new ArrayList<>();
        ArrayAdapter<String> adapter=new ArrayAdapter<>(this,android.R.layout.simple_list_item_1,data);
        list.setAdapter(adapter);
        data.add("신문수 : 010-5564-1577");
        data.add("최창섭 : 010-9310-2763");
        data.add("심규대 : 010-4955-6004");
        data.add("정인준 : 010-3223-0040");
        ...
        ListView listView = findViewById(R.id.lv_blueberry);
