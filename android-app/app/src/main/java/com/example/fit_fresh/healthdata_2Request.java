...
public class healthdata_2Request  extends StringRequest {

    //서버 url 설정(php파일 연동)
    //final static  private String URL="http://computernano.dothome.co.kr/data_input.php";
    final static  private String URL = "http://10.0.2.2:8080/data_input.php";
    ...
    public healthdata_2Request(String name, String age, String time,String carbo,String protein,String fat, Response.Listener<String>listener){
