...
public class watermelon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list= findViewById(R.id.lv_watermelon);
        List<String> data = new ArrayList<>();
        ArrayAdapter<String> adapter=new ArrayAdapter<>(this,android.R.layout.simple_list_item_1,data);
        list.setAdapter(adapter);
        data.add("안혁기 : 010-9406-1259");
        data.add("정시영 : 010-8463-7681");
        data.add("이종문 : 010-5485-2750");
        data.add("김계순(부자농부) : 010-4377-5178");
        ...
        ListView listView = findViewById(R.id.lv_watermelon);
